FILES = ./build/kernel.asm.o ./build/isr80h/process.o ./build/kernel.o ./build/isr80h/isr80h.o ./build/keyboard/keyboard.o ./build/keyboard/classic.o ./build/isr80h/io.o ./build/isr80h/misc.o ./build/disk/disk.o ./build/disk/streamer.o ./build/task/process.o ./build/task/task.o ./build/task/task.asm.o ./build/task/tss.asm.o ./build/fs/pparser.o ./build/fs/file.o ./build/fs/fat/fat16.o ./build/string/string.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/gdt/gdt.o ./build/gdt/gdt.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o
INCLUDES = -I./src
FLAGS = -g -ffreestanding -falign-jumps -falign-functions -falign-labels -falign-loops -fstrength-reduce -fomit-frame-pointer -finline-functions -Wno-unused-function -fno-builtin -Werror -Wno-unused-label -Wno-cpp -Wno-unused-parameter -nostdlib -nostartfiles -nodefaultlibs -Wall -O0 -Iinc -fno-pic -fno-pie
...
all: ./bin/boot.bin ./bin/kernel.bin user_programs
	...
	# Use mtools to copy files into the FAT16 partition
	MTOOLS_SKIP_CHECK=1 mformat -i ./bin/os.bin@@512 -F ::
	MTOOLS_SKIP_CHECK=1 mcopy -i ./bin/os.bin@@512 ./hello.txt ::hello.txt
	MTOOLS_SKIP_CHECK=1 mcopy -i ./bin/os.bin@@512 ./programs/blank/blank.bin ::blank.bin
	MTOOLS_SKIP_CHECK=1 mcopy -i ./bin/os.bin@@512 ./programs/shell/shell.bin ::shell.bin
